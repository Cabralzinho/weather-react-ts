...
export const SectionTemperature = () => {
  ...
  const weatherIcons = {
    Clear: "./src/assets/ilustrator/sunLight.svg",
    Clouds: "./src/assets/ilustrator/cloudFull.svg",
    Rain: "./src/assets/ilustrator/rain.svg",
    Snow: "./src/assets/ilustrator/snow.svg"
  };
